                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ route("admin.testimonials.update", [$testimonial->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $testimonial->title) }}">
                            @if($errors->has('title'))
...
@if(isset($testimonial) && $testimonial->photo)
      ...
      this.options.thumbnail.call(this, file, '{{ $testimonial->photo->getUrl('thumb') }}')
