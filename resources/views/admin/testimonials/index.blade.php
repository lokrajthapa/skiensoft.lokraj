                                    ...
                                    <tr data-entry-id="{{ $testimonial->id }}">
                                        ...
                                        <td>
                                            @if($testimonial->photo)
                                                <a href="{{ $testimonial->photo->getUrl() }}" target="_blank">
                                                    <img src="{{ $testimonial->photo->getUrl('thumb') }}" width="50px" height="50px">
                                                </a>
                                            @endif
                                        </td>
                                        <td>
...
@endcan
  ...
  $('.datatable-Testimonial:not(.ajaxTable)').DataTable({ buttons: dtButtons })
